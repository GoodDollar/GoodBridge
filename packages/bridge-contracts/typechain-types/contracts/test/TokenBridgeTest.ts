...
export interface TokenBridgeTestInterface extends utils.Interface {
  functions: {
...
export interface TokenBridgeTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokenBridgeTestInterface;
