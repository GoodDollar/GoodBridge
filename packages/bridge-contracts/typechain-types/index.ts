...
export type { IFeesFormula } from "./@gooddollar/goodprotocol/contracts/token/IFeesFormula";
export { IFeesFormula__factory } from "./factories/@gooddollar/goodprotocol/contracts/token/IFeesFormula__factory";
