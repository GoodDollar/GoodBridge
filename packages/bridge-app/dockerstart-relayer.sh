...
docker run -d -e DOTENV_FILE=/config/.env -e LOG_LEVEL=info --name bridgerelay --volume $PWD/relayer:/config --restart=always gooddollar/bridge-app dist/relayMain.js
